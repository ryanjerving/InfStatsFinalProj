...
```{r difference-between-two-proportions}
...
The probability that we would see a difference this extreme or more is expressed in the p-value associated with this Z score: `r round(pvalDiffGovt,3)`. This value falls well below the 0.05 threshold of signficance at the 95% confidence level we are using, so we can safely reject the null hypothesis. 
