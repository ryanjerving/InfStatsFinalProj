...
$$H_A: p_{2012} - p_{2012} \neq 0$$
Our conditions for conducting this test in relation to the Central Limit Theoresm remain as before: the samples are independent and and the size/skew of our sample raises no red flags.

The $Z$ score from which we'll derive our **p-value** -- essentially, the probability that even if the null hypothesis is true we could still see results as extreme or greater than the results we observe in our sample -- is based on the distance of the observed difference in proportion
